...
free.red.lunch.2018 <- read_csv("2018_free_red_lunch.csv") %>%
  select (DistrictName, K12Enr, FreeK12, RedK12) %>%
...
free.red.lunch.2012 <- read_csv("2012_free_red_lunch.csv") %>%
  ...
  select(DistrictName, percentLunch2012)

free.red.lunch.2011 <- read_csv("2011_free_red_lunch.csv") %>%
  select (DistrictName, K12Enr, FreeK12, RedK12) %>%
  mutate(
    K12Enr = na_if(K12Enr, "NULL"),
    FreeK12 = na_if(FreeK12, "NULL"),
  ...
  select(DistrictName, percentLunch2011)
...
free.red.lunch.2006_2018 <- full_join(free.red.lunch.2018, free.red.lunch.2017, by = c("DistrictName")) %>%
  full_join(free.red.lunch.2016, free.red.lunch.2006_2018, by =c("DistrictName")) %>%
  full_join(free.red.lunch.2015, free.red.lunch.2006_2018, by =c("DistrictName")) %>%
  full_join(free.red.lunch.2014, free.red.lunch.2006_2018, by =c("DistrictName")) %>%
  full_join(free.red.lunch.2013, free.red.lunch.2006_2018, by =c("DistrictName")) %>%
  full_join(free.red.lunch.2012, free.red.lunch.2006_2018, by =c("DistrictName")) %>%
  full_join(free.red.lunch.2011, free.red.lunch.2006_2018, by =c("DistrictName")) %>%
  full_join(free.red.lunch.2010, free.red.lunch.2006_2018, by =c("DistrictName")) %>%
  full_join(free.red.lunch.2009, free.red.lunch.2006_2018, by =c("DistrictName")) %>%
  full_join(free.red.lunch.2008, free.red.lunch.2006_2018, by =c("DistrictName")) %>%
  full_join(free.red.lunch.2007, free.red.lunch.2006_2018, by =c("DistrictName")) %>%
  full_join(free.red.lunch.2006, free.red.lunch.2006_2018, by =c("DistrictName")) %>%

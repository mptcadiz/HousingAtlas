...
grad.math.2013 <- read_csv("2013_grad_math.csv") %>%
...
grad.math.2012 <- read_csv("2012_grad_math.csv") %>%
select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.math.2011 <- read_csv("2011_grad_math.csv") %>%
select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.math.2010 <- read_csv("2010_grad_math.csv") %>%
select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.math.2009 <- read_csv("2009_grad_math.csv") %>%
select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.math.nonpub.2013 <- read_csv("2013_grad_math_nonpub.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.math.nonpub.2012 <- read_csv("2012_grad_math_nonpub.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.math.nonpub.2011 <- read_csv("2011_grad_math_nonpub.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.math.nonpub.2010 <- read_csv("2010_grad_math_nonpub.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.math.nonpub.2009 <- read_csv("2009_grad_math_nonpub.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",

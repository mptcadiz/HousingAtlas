...
grad.reading.2012 <- read_csv("2012_grad_reading.csv") %>%
...
grad.reading.2011 <- read_csv("2011_grad_reading.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.reading.2010 <- read_csv("2010_grad_reading.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.reading.2009 <- read_csv("2009_grad_reading.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.reading.2008 <- read_csv("2008_grad_reading.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.reading.nonpub.2012 <- read_csv("2012_grad_reading_nonpub.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.reading.nonpub.2011 <- read_csv("2011_grad_reading_nonpub.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.reading.nonpub.2010 <- read_csv("2010_grad_reading_nonpub.csv") %>%
...
grad.reading.nonpub.2009 <- read_csv("2009_grad_reading_nonpub.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
...
grad.reading.nonpub.2008 <- read_csv("2008_grad_reading_nonpub.csv") %>%
  select ("District Number", "District Type", "District Name", "Percent Passed", "Average Score") %>%
  rename(
    districtNumber= "District Number",
    districtType = "District Type",
